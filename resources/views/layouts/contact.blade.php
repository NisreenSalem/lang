...
<body>
    ...
    <style>
        ...
        *:after {
        ...
        body {
            background: linear-gradient(to right, #e011ab 0%, #9b466b 100%);
            font-size: 12px;
        }
    ...
    <h1>{{__('message.contentForm')}}</h1>
    <form method="POST" name="contacts" id="contacts" action="{{route('recieveContact')}}">
        @csrf
